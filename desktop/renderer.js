...
const PRESETS = {
  "平衡钢笔稿": {
    ...
    "architectural_style.structure_line_type": "straight",
    "architectural_style.facade_hatch_line_type": "straight",
  ...
  "建筑细节强化": {
    ...
    "architectural_style.structure_line_type": "sketch",
    "architectural_style.facade_hatch_line_type": "straight",
    "architectural_style.entourage_line_type": "loose_curve",
  },
  "植物速写概括": {
    ...
    "architectural_style.structure_line_type": "slight_curve",
    "architectural_style.facade_hatch_line_type": "broken",
    "architectural_style.entourage_line_type": "loose_curve",
  },
  "极简留白": {
    "image.max_size": 1200,
  ...
  "历史建筑竖向速写": {
    ...
    "architectural_style.structure_line_type": "sketch",
    "architectural_style.facade_hatch_line_type": "slight_curve",
    "architectural_style.entourage_line_type": "loose_curve",
  },
  "建筑浓密阴影": {
    "image.max_size": 1500,
...
const PARAM_GROUPS = [
  ...
  },
  {
    ...
    params: [
      ...
      { path: "architectural_style.structure_line_type", label: "结构线型", type: "select", values: ["straight", "slight_curve", "loose_curve", "sketch", "broken", "broken_curve"] },
      { path: "architectural_style.facade_hatch_line_type", label: "立面线型", type: "select", values: ["straight", "slight_curve", "loose_curve", "sketch", "broken", "broken_curve"] },
      { path: "architectural_style.entourage_line_type", label: "周边线型", type: "select", values: ["straight", "slight_curve", "loose_curve", "sketch", "broken", "broken_curve"] },
      ...
      { path: "architectural_style.line_curvature_px", label: "曲线弧度", type: "float", min: 0, max: 12, step: 0.1 },
      { path: "architectural_style.sketch_wobble_px", label: "速写抖动", type: "float", min: 0, max: 5, step: 0.1 },
      { path: "architectural_style.broken_gap_ratio", label: "断续空隙", type: "float", min: 0.05, max: 0.65, step: 0.01 },
